...
shapefile <- read_sf(here("raw_data/canada_province_shapefile/gpr_000b11a_e.shp"))
population <- read_csv(here("raw_data/1710000901-eng.csv"), skip = 5)
```
...
May or may not do this - think the data is a survey sample so won't be able to calculate rates.
